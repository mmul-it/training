# Exercise | Create a custom container image | Solution
...
2. The `Dockerfile` file should have this contents:
   ...
   There's a [downloadable copy](https://github.com/mmul-it/training/raw/master/Kubernetes-From-Scratch/Create-Custom-Image.Dockerfile)
