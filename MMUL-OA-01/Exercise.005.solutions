# Exercise 005 - Customize a DeploymentConfig on OpenShift - Solutions

1) Use the command 'oc new-app' to create the yaml file:

> oc new-app mariadb MYSQL_USER=user MYSQL_PASSWORD=pass MYSQL_DATABASE=testdb -l db=mariadb > dc-mariadb.yaml

2) Check the content of dc-mariadb.yaml:
